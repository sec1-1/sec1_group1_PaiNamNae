...
### AI declaration
โครงงานชิ้นนี้ ได้มีการนําปัญญาประดิษฐ์ ChatGPT5.2 , Claude Sonnet 4.6 มาใช้เพื่อช่วยในการพัฒนา และจัดโครงสร้างเนื้อหาให้อ่านง่ายขึ้น โดยเฉพาะในส่วนต่อไปนี้:
- จัดองค์ประกอบส่วน frontend ให้อ่านง่าย
- สร้าง test case ให้ครอบคลุมมากยิ่งขึ้น
- จัดฟอร์แมต user manual
